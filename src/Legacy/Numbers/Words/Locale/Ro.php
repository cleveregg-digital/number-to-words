...
namespace CleverEggDigital\NumberToWords\Legacy\Numbers\Words\Locale;

use ClevereggDigital\NumberToWords\Exception\NumberToWordsException;
use CleverEggDigital\NumberToWords\Grammar\Gender;
use CleverEggDigital\NumberToWords\Language\Romanian\Dictionary;
...
class Ro extends Words
{
     ...
     * @return string
     */
    private function getNounDeclensionForNumber($pluralRule, $noun): string
    {
     ...
     * @return string
     */
    private function getPluralRule($number): string
    {
        // One
     ...
     * @return string
     */
    private function showDigitsGroup($number, $noun, $forceNoun = false, $forcePlural = false): string
    {
        $ret = '';
     ...
     * @return string
     */
    protected function toWords($num = 0, $noun = []): string
    {
        if (empty($noun)) {
